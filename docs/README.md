---
description: BlockCanvas 마인크래프트 건축 서버와 웹 플랫폼 공식 이용 가이드
icon: house
...
<img src=".gitbook/assets/logo.png" alt="BlockCanvas" width="120">
...
{% hint style="info" %}
처음이라면 **[시작하기](getting-started/README.md)** 부터 순서대로 읽어 주세요. 가입 → 계정 연동 → 서버 접속까지 5분이면 됩니다.
{% endhint %}
...
| | |
| --- | --- |
| 🚀 [시작하기](getting-started/README.md) | 회원가입·계정 연동·서버 접속 |
